...
export const Post = ({
  ...
  return (
    <>
      ...
      <div className="aspect-auto z-50 bg-black flex items-center md:overflow-hidden justify-center">
        <CldImage
          src={post?.imageUrl!}
          alt="Image"
          width="600"
      ...
      <div className="md:min-w-[10rem] w-full  md:border flex flex-col">
